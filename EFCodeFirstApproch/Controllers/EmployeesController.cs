...
namespace EFCodeFirstApproch.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Age,DepartmentID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Age,DepartmentID")] Employee employee)
        {
            if (id != employee.ID)
            {
                return NotFound();
